...
var app = {
    ...
    receivedEvent: function(id) {
        ...
        parentElement.addEventListener('click', self.startSpeechToText);
        
        var tts = document.getElementById('transcript');
        tts.addEventListener('click', function(){
            self.startTextToSpeech(tts.innerText);
        });

        var title = document.getElementById('title');
        title.addEventListener('click', function(){
            self.startTextToSpeech(title.innerText);
        });
    ...
    startSpeechToText: function(){
        ...
        WatsonSDK.SpeechToText.init(VCAP_OBJECT,function(data){
            if(data){
                console.log("True")
